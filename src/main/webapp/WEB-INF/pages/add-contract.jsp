	...
	<div class="col-sm-3"
		...
		<div id="menu">
			<ul>
				...
				<li><a href="./Users.html">Manage Contract</a></li>
  ...
  <div class="col-md-10 col-md-offset-1"> 
   <div class="panel panel-default panel-table"> 
    <div class="panel-heading"> 
     <div class="row"> 
      <div class="col col-xs-6"> 
       <h3 class="panel-title"style="font-size:26px">ADD CONTRACT</h3> 
      </div> 
    ...
    <br> 
     ...
     <p style="position: absolute;left: 30px;">Coach:</p> <input type="text" style="position: absolute;left: 150px; width: 350px;"value="Nguyen Minh Thu"><br><br> 
     <p style="position: absolute;left: 30px;">Email-coach:</p>  <input type="text" style="position: absolute;left: 150px; width: 350px" value="thunguyen@gmail.com"><br><br>
     <p style="position: absolute;left: 30px;">Student:</p> <input type="text" style="position: absolute;left: 150px; width: 350px;"value="Nguyen Thanh Nhan"><br><br>
     <p style="position: absolute;left: 30px;">Email-student:</p>  <input type="text" style="position: absolute;left: 150px; width: 350px;" value="nhannguyen@gmail.com"><br><br>
