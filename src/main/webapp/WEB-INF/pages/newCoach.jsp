				...
				<div class="panel panel-default panel-table">
					...
					<div class="panel-body" style="height: 450px;">
						...
						<form:form method="post" modelAttribute="coach">
							<input hidden="true" name="idCoach" type="text"
								value="${Coach.idCoach}">
							<p class="emailOfCoach">* Email of Coach :</p>

							<form:input path="emailOfCoach" type="text" class="emailOfCoach"
								id="emailOfCoach" />
							<br>
							<br>
							<center>
							...
							<form:input path="name" type="text" class="name" id="name" />
							<br>
							<br>
							<center>
								<p id="errorName" class="errorName"></p>
							</center>

							<p class="department">Department :</p>
							<form:input path="department" type="text" class="department"
								id="department" />
							<br>
							<br>
							<center>
								<p id="errorDepartment" class="errorDepartment"></p>
							</center>
							<p class="telephone">Telephone :</p>
							<form:input path="telephone" type="text" class="telephone"
								id="telephone" />
							<br>
							<br>
							<center>
								<p id="errorPhone" class="errorPhone"></p>
							</center>
							<br>
